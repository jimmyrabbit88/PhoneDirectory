    ...
    private class ButtonHandler implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            if (e.getSource() == nextButton) {
                ...
                String srcName = JOptionPane.showInputDialog("Enter Name to find");
                String msg = phoneDirectory.search(srcName);
                if(msg==null){
                    JOptionPane.showMessageDialog(null, "not found");
                }
                else {
                    JOptionPane.showMessageDialog(null, "found number is: "+msg);
                }
            }
        }
    }
